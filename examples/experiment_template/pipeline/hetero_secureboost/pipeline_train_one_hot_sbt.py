...
def main(config="../../config.yaml", namespace=""):
    ...
    one_hot_encoder_0.get_party_instance(role='guest', party_id=guest).algorithm_param(need_run=False)
    one_hot_encoder_0.get_party_instance(role='host', party_id=host)
    one_hot_encoder_1.get_party_instance(role='guest', party_id=guest).algorithm_param(need_run=False)
